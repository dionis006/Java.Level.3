...
public class Car extends Transport {
    ...
    static final private String name = "car";
    static public double tank = 20;
    static final private int fullTank = 20;
    static private final double consumption = 2.5;
    FuelStation fuelStation;
    private String brand;

    public Car(FuelStation fuelStation, String brand) {
        this.brand = brand;
